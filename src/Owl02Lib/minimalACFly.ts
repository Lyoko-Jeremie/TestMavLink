 ...
 * MAV_COMP_ID_ALL value is used to indicate messages that must be processed by all components.
 When
...
export enum MavComponent {
   ...
   * Camera #5.
   */
  'CAMERA_SkyDroid_2_Axis'                       = 106,

  /**
   * Camera #5.
   */
  'CAMERA_SkyDroid_3_Axis'                       = 107,

  /**
   * Camera #5.
   */
  'CAMERA_NEXTVISION'                            = 108,

  /**
   * Camera #5.
   */
  'HYDROGEN_BATTERY'                             = 139,
